...
export const FormProduct = React.lazy(() => import ('../pages/FormProduct/FormProduct'))
export const ProductDetails = React.lazy(() => import ('../pages/Product/ProductDetails/index'))
